class Solution:
    def isInterleave(self, s1: str, s2: str, s3: str) -> bool:
        ...
        for idx1 in range(s1_size + 1):
            for idx2 in range(s2_size + 1):
                if idx1 == 0 and idx2 == 0:
                    table[idx1][idx2] = True
                elif idx1 == 0:
                    table[idx1][idx2] = (s2[idx2 - 1] == s3[idx2 - 1] and table[idx1][idx2 - 1])
                elif idx2 == 0:
                    table[idx1][idx2] = (s1[idx1 - 1] == s3[idx1 - 1] and table[idx1 - 1][idx2])
                else:
